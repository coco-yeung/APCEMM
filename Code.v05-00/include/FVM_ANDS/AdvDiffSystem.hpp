...
namespace FVM_ANDS{
    ...
    class AdvDiffSystem{
        public:
            ...
            Eigen::VectorXd xSemiLagrangianAdvection(bool parallelAdvection = false) noexcept;
            Eigen::VectorXd xForwardEulerAdvection(bool operatorSplit = false, bool parallelAdvection = false) const noexcept;
            Eigen::VectorXd ySemiLagrangianAdvection(bool parallelAdvection = false) noexcept;
